...
val _ = okEq "test2c" word32 (Word32.fromLargeInt (Int32.toLarge maxInt32))
val _ = okEq "test2d" word32 (Word32.fromLargeInt (Int32.toLarge minInt32))
...
(* listGen0 *)
val _ = okEq "test20a_0" (listGen0 int) [~1,2,1,2,4,0,5,6,7,8]
val _ = okEq "test20b_0" (listGen0 int) [~1,2000,1100,~2000,~400000,5,6000,7,8,0]
val _ = okEq "test20c_0" (listGen0 int) [maxInt,minInt]
val _ = okEq "test20d_0" (listGen0(pairGen(int,bool))) [(1,true),(2,false),(~34,true),(0,false)]
val _ = okEq "test20e_0" (listGen0(pairGen(int,bool))) [(maxInt,true),(minInt,false)]
val _ = okEq "test20f_0" (pairGen(int,listGen0(pairGen(int,bool)))) (34,[(maxInt,true),(minInt,false)])
val _ = okEq "test20g_0" (pairGen(int,listGen0(pairGen(int,bool)))) (2333,[(1,true),(2,false),(~34,true),(0,false)])
val _ = okEq "test20h_0" (pairGen(listGen0(pairGen(int,bool)),int)) ([(1,true),(2,false),(~34,true),(0,false)], ~333)
val _ = okEq "test20i_0" (pairGen(int,listGen0 char)) (~2333,mkS(100,nil))
val _ = okEq "test20j_0" (pairGen(int,listGen0 char)) (2333,mkS(1000,nil))
(*
val _ = okEq "test20k" (pairGen(int,listGen0 char)) (~2333,mkS(2000,nil))
val _ = okEq "test20l" (pairGen(int,listGen0 char)) (~2333,mkS(100000,nil))
*)

val _ = okEq "test20m_0" (pairGen(int,listGen0 char)) (~2333,nil)
val _ = okEq "test20n_0" (pairGen(listGen0 char,int)) (nil,~2)
val _ = okEq "test20o_0" (listGen0 int) nil
val _ = okEq "test20p_0" (listGen0 char) nil
